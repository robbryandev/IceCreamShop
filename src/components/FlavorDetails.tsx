...
export default class FlavorDetails extends Component<{flavor: FlavorType, globalEdit: editProps, setGlobal: any, setDetails: any}> {
  render() {
    return (
      <div className="text-center text-teal-300 mt-6">
        <p className="text-4xl text-shadow font-bold">
        ...
        <br />
        <p className="text-lg text-shadow font-semibold">Flavor: {this.props.flavor.flavor}</p>
